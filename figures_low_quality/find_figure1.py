...
find_near_points_pairs = utils.find_near_points_pairs
filter_edge_corners = utils.filter_edge_corners
check_corner_coordinates = utils.check_corner_coordinates
additional_corners_coordinates_of_rectangle_search = utils.additional_corners_coordinates_of_rectangle_search
find_corners_coordinates = utils.find_corners_coordinates
sort_corners_coordinates_of_rectangle = utils.sort_corners_coordinates_of_rectangle
cut_corners = utils.cut_corners
...
cv2.imwrite(f"data/modified_figure1.jpg", modified_img)
...
angles_coordinates.extend(angles_coordinates2)


coordinates = find_corners_coordinates(angles_coordinates, graph1)
coordinates = sort_corners_coordinates_of_rectangle(coordinates)
img = cut_corners(coordinates, img)

cv2.imwrite("data/cache/modified_img1.jpg", img)


img_name = "data/cache/modified_img1.jpg"
