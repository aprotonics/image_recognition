...
for i in range(2, 6):
    console_log(f"Iterations: {i}")
    angles_coordinates1 = push(find_outer_angles_coordinates(graph2, 8, i, img, quality), angles_coordinates1)
...
cv2.imwrite("data/modified_polygon7.jpg", modified_img)
