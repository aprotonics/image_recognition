...
cv2.imwrite("data/modified_polygon8.jpg", modified_img)
...
for i in range(2, 6):
    ...
    console_log(f"Iterations: {i}")
    middle_coordinates = find_outer_angles_coordinates(graph, 1, i, modified_img, quality)
