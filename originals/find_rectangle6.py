...
img_name = "data/original6.jpg"
output = "output/find_rectangle6.txt"
...
cv2.imwrite("data/modified_original6.jpg", modified_img)
...
if isolated_subgraphs_count == 1:
    with open(file=output, mode="at", encoding="utf-8") as f:
        f.write(str("graph is consistent"))
        f.write("\n")
        f.write("\n")
else:
    with open(file=output, mode="at", encoding="utf-8") as f:
        f.write(str("graph is not consistent"))
        f.write("\n")
        f.write("\n")

with open(file=output, mode="at", encoding="utf-8") as f:
    f.write(str("number of isolated subgraphs"))
    f.write("\n")
    f.write(str(isolated_subgraphs_count))
    f.write("\n")
    f.write("\n")
