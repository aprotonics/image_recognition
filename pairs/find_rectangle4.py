...
for i in range(2, 6):
    console_log(f"Iterations: {i}")
    angles_coordinates1 = push(find_outer_angles_coordinates(graph2, 4, i, img, quality), angles_coordinates1)
...
cv2.imwrite("data/modified_pair4.jpg", modified_img)
...
graphs_list = []
for rectangle_area in rectangle_areas_list:
    graph = create_graph(rectangle_area)
