...
for i in range(2, 6):
    ...
    angles_coordinates1 = push(find_outer_angles_coordinates(graph, 3, i, img, quality), angles_coordinates1)
...
cv2.imwrite("data/modified_triangle25.jpg", modified_img)
...
for i in range(2, 6):
    console_log(f"Iterations: {i}")
    angles_coordinates2 = push(find_inner_angles_coordinates(graph, 3, i, modified_img, quality), angles_coordinates2)
